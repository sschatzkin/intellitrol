 ...
 *
 *   Description:  Header File for I2C module definitions
 *
 * Revision History:
 *   Rev      Date        Who   Description of Change Made
 *  --------  --------   ----    --------------------------------------------
 * 1.5.00   04/22/08  KLL    Port of old Intellitrol code
 * 1.5.28   05/08/14  DHP   Added definition for I2C_CON.
 ********************************************************************************************/
#ifndef I2C_H
#define I2C_H

/*****************************************************************************
 * Per the PIC24F FAMILY Reference Manual;  I2CxBRG = ((Fcy/(2*Fscl)) - 1
 * KLL's comments have I2CxBRG = Fcy/Fscl - Fcy/10,000,000 - 1
 * Testing shows for 400 kHz a value of 0x2C provides the closest result; KLLs formula = 0x2F
 * With I2C2_BRG < 0x1B the circuit does not work; ACK timeout on first write.
 *****************************************************************************/
#define I2C1_BRG (((FCY/400000) - (FCY/10000000))) - 1   /* 400K Bus */
#define I2C2_BRG (((FCY/400000) - (FCY/10000000))) -1    /* 400K Bus */
#define I2C2_CON (0x8000)   /* I2CEN (DISSLW not used for 1M) */
...
int StopI2C1(void) __attribute__ ((section (".libperi")));
...
unsigned char MasterputsI2C2(char *, unsigned char) __attribute__ ((section (".libperi")));
...
unsigned char MasterReadI2C2(unsigned char *) __attribute__ ((section (".libperi")));
...
int StopI2C2(void) __attribute__ ((section (".libperi")));
