...
*/
static void __attribute__((__section__(".LoaderSection")))
...
unsigned long long __attribute__((__section__(".LoaderSection")))
...
long long __attribute__((__section__(".LoaderSection")))
